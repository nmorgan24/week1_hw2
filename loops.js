...
for(let nums2 = 2; nums2 <= 98; nums2 = nums2 + 2) {
    console.log(nums2); //couldnt get 0 here
}


//Create a loop that logs the EVEN numbers from 98-0 (descending)
for(let nums2 = 98; nums2 > 0; nums2 = nums2 - 2) {
    console.log(nums2); //couldnt get 0
}
...
for(let nums6 = 1; nums6 <= 99; nums6 = nums6 + 2) {
    console.log(nums6) //couldnt get 0 here
}

//Create a loop that logs the ODD numbers from 99-0 (descending)
for(let nums6 = 99; nums6 > 0; nums6 = nums6 - 2) {
    console.log(nums6);  //i couldnt get it to 0
}
